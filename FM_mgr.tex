...
\begin{figure}[h]
	...
	\node[right] at (4.5, -3.5) {$\param{operatorKrzyzowania}$};
...
\begin{signature}
	...
	\begin{align}
	\param{operatorMutacji}: & \important{S} \rightarrow \withSize{\important{S}}{\variable{m}} \\
	\param{prawdopodobienstwoMutacji} \in & \range{0}{1}
	\end{align}
...
\begin{signature}
	...
	\begin{align}
	\param{operatorKrzyzowania}: & \withSize{\important{S}}{\inputVar{c}} \rightarrow \withSize{\important{S}}{\outputVar{c}} \\
	\param{prawdopodobienstwoKrzyzowania} \in & \range{0}{1}
	\end{align}
...
\begin{signature}
	...
	\begin{align}
	\param{operatorSelekcji}: &\withSize{\important{S}}{p} \rightarrow \withSize{\important{S}}{\param{rozmiarPopulacji}} \\
	...
	s \in \param{operatorSelekcji}(T) &\Leftrightarrow \exists_{t \in T}  t = s \\
