...
\newcommand{\minorityRel}{{\R}_{\prec}}
...
\begin{signature}
	...
	\begin{align}
		...
		\exists \minorityRel \subset \important{E} \times \important{E}
	\end{align}
	Zbiór $\important{E}$ to zbiór możliwych ocen osobnika, 
	a $\minorityRel$ to relacja porządku na nim określona. 
\end{signature}
...
\begin{signature}
	...
	P(i) < P(j) &\Leftrightarrow (t_i, t_j) \in \minorityRel
	\end{align}
\end{signature}
