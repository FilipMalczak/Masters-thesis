...
\paragraph{Konfiguracja} Zestawy wartości parametrów zostały określone podobnie jak na analogicznym etapie badań problemu TSP - przez dodanie lub odjęcie do parametrów liczbowych 5 i 10 lub 0,02 i 0,05, \fixme{zachowując ograniczenie na ich przedział}.
